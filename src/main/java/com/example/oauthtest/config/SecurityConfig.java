...
import com.example.oauthtest.oauth.*;
import com.example.oauthtest.oauth.exception.RestAuthenticationEntryPoint;
...
import com.example.oauthtest.oauth.handler.TokenAccessDeniedHandler;
import com.example.oauthtest.oauth.service.CustomOAuth2UserService;
import com.example.oauthtest.oauth.service.CustomUserDetailsService;
import com.example.oauthtest.oauth.token.TokenAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/oauth/redirect").permitAll()
